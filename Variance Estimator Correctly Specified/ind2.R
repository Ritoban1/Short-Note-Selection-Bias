...
sr_l=mat_lauren-1.96*mat_var_lauren
sr_u=mat_lauren+1.96*mat_var_lauren

pl_l=mat_chen-1.96*mat_var_chen
pl_u=mat_chen+1.96*mat_var_chen


#sr_mc=sd(mat_lauren[,3])
#sr_est=mean(mat_var_lauren[,3])
pl_mc=sd(mat_chen[,3])
pl_est=(mean(mat_var_chen[,3]))


list=list(sr_l,sr_u,pl_l,pl_u,mat_lauren,mat_chen)
saveRDS(list,"ind2.rds")
